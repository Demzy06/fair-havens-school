...
function GallerySliderOverlay({
  ...
  return (
    <>
      {/* Overlay */}
      <div
        className="fixed w-full h-full top-0 left-0 right-0 bottom-0 z-2 bg-[rgba(0,0,0,0.95)] overlay "
        onClick={(e) => onHandleOverlay(e)}
      >
        {/* Image */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[88%]  ">
          <button
          ...
          <img
            ...
            className="m-auto w-full z-10 rounded-2xl "
          />
          <button
